    ...
    <div class="content mar_20">
        ...
        <div class="l_list">
            ...
            <div class="list_c">
                ...
                <ul class="cate_list">
                    <c:forEach var="product" items="${page.data}">
                        <li>
                            <div class="img"><a href="#"><img src="<%=path%>/images/${product.fileName}" width="210" height="185" /></a></div>
                            <div class="price">
...
<script type="text/javascript" src="<%=path%>/js/product/cart.js"></script>
<script>
